...
from .navigator import get_page_structure, verify_selectors_with_samples, capture_xhr_requests, browse_web
...
from .analyst import load_json_data, create_chart, write_report

# 🏭 도구 팩토리 그룹화 (Tool Factory Groups)
tools_navigator = [
    get_page_structure,
    verify_selectors_with_samples,
    capture_xhr_requests,
    browse_web,
]
...
tools_all = (
    ...
    + tools_supervisor
    + tools_user
    + [load_json_data, create_chart, write_report]
)

__all__ = [
    "ARTIFACT_DIR",
    "tools_navigator", "tools_coder", "tools_supervisor", "tools_user", "tools_image", "tools_analyst", "tools_all",
    "get_page_structure", "verify_selectors_with_samples", "capture_xhr_requests", "browse_web",
